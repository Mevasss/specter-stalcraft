...
#define	PROTECT_VM(text)  VMProtectBeginVirtualization(text)
#define PROTECT_MUT(text) VMProtectBeginMutation(text);
#define PROTECT_ULTRA(text) VMProtectBeginUltra(text);
#define PROTECT_END() VMProtectEnd()
#define _(text) VMProtectDecryptStringA(text)
#define _w(text) VMProtectDecryptStringW(text)

#else
#define	PROTECT_VM(text)
#define PROTECT_MUT(text)
#define PROTECT_ULTRA(text)
#define PROTECT_END(text)
#define _(text) text
#define _w(text) text
#endif